...
//  game
//
//  Created by Hassan Farooq on 12/7/13.
...
-(void)EnemyMove
{
    Enemy6.center = CGPointMake(Enemy6.center.x, Enemy6.center.y +3.25);
    if(Enemy6.center.y > 500)
    {
        Enemy6.center = CGPointMake(Enemy6.center.x, -40);
    }
}
