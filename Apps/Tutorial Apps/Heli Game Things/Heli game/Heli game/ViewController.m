...
-(void)EndGame
{
    ...
    [self performSelector:@selector(NewGame) withObject:nil afterDelay:2.5];
}
...
-(void)NewGame
{
    ...
    Heli.image = [UIImage imageNamed:@"Ball.jpg"];
...
-(void)HeliMove
{
    ...
    if (Obstacle2.center.x < 0)
    {
        RandomPosition = arc4random() %75;
        RandomPosition = RandomPosition + 110;
        Obstacle2.center = CGPointMake(600, RandomPosition);
    }
    if (Top1.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top1.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom1.center = CGPointMake(600, RandomPosition);
    }
    if (Top2.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top2.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom2.center = CGPointMake(600, RandomPosition);
    }
    if (Top3.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top3.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom3.center = CGPointMake(600, RandomPosition);
    }
    if (Top4.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top4.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom4.center = CGPointMake(600, RandomPosition);
    }
    if (Top5.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top5.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom5.center = CGPointMake(600, RandomPosition);
    }
    if (Top6.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top6.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom6.center = CGPointMake(600, RandomPosition);
    }
    if (Top7.center.x < -30)
    {
        RandomPosition = arc4random() %55;
        Top7.center = CGPointMake(600, RandomPosition);
        RandomPosition = RandomPosition + 265;
        Bottom7.center = CGPointMake(600, RandomPosition);
    }
}
